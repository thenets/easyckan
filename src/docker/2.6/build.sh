...
CKAN_IMAGES=(ckan ckan-cli ckan-dev ckan-postgres ckan-production ckan-solr ckan-supervisor ckan-datapusher)
# CKAN_IMAGES=(ckan ckan-cli ckan-dev ckan-production ckan-datapusher) # DEBUG
# CKAN_IMAGES=(ckan-supervisor) # DEBUG
# CKAN_IMAGES=(ckan-production) # DEBUG
CKAN_IMAGES=(ckan-datapusher) # DEBUG
